    ...
    if ($memi50 && $memi50->num_rows > 0) {
        ...
        $sq1 =
            "UPDATE convocatoria SET escrutinio='Cerrado' WHERE escrutinio='Abierto' ";
        ...
        for ($cont2 = 0; $cont < $num; $cont2++) {
            $sql1 =
                "SELECT id,votosTotales FROM partido WHERE ID='" . $cont2 . "'";
        ...
        foreach ($listaVot as $key => $value) {
            $sq1 =
                "INSERT INTO resultado(convocatoria,partido,totalVotos)   VALUES(" .
                $info1["id"] .
                "," .
                $key .
                "," .
        ...
        //    $sq1="UPDATE partido SET votosTotales=0 ";
        //$comprobar=$conexion->query($sq1);
        //
        //
        //if ($conexion->affected_rows>0 ){
        ...
        $_SESSION["mensajeBD"] =
            "Escrutinio Cerrado. Ya se pueden consultar los resultados desde el menu";
