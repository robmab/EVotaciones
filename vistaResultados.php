                        ...
                        <tbody>
                            ...
                            <tr class="row100">
                                <td class="column100 column1" data-column="column1">
                                    <?php
                                        if($cont == 1){ ?>
                                    <center><img style="width:100px;height:100px;" src="images/1.png"></center>
                                    <?php }
                                        if($cont > 1){ ?> 
                                    <center>
                                        <b>
                                            <h1> <?php echo $cont ?>º </h1>
                                        </b>
                                    </center>
                                    <?php  };
                                        $cont++ ;
                                ...
                                <?php }; ?>
                                <?php if ( $indice == 1){ ?>
                                <td class="column100 column2" data-column="column2"><b> <?php
                                    echo $value ?> </b></td>
                                <?php
                                    ?>
                            </tr>
                                ...
                                <?php     
                                    $array= array();
                                        ...
                                        foreach ($_SESSION['resultados'] as $key => $value) {
                                         ...
                                         ?>    
                                <option value="<?php echo $array['denominacion']?>"><?php  echo $array['denominacion']  ?> - 
                                    <?php echo $array['circunscripcion']  ?> - <?php echo $array['fecha']  ?>
                                </option>
                                <?php
                                    }
