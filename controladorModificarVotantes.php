    ...
    if ($memi5 && $memi5->num_rows > 0) {
        $_SESSION["mensajeBD"] =
            "No puedes modificar tu usuario mientras este el escrutinio abierto ";
    ...
    if (isset($_REQUEST["contraseñaA"]) && $_REQUEST["contraseñaA"] != "") {
        ...
        if (isset($_REQUEST["contraseñaN"]) && $_REQUEST["contraseñaN"] != "") {
            ...
            if (
                isset($_REQUEST["contraseñaN2"]) &&
                $_REQUEST["contraseñaN2"] != ""
            ) {
                ...
                if ($cont = 1) {
                    ...
                    if ($conexion->affected_rows > 0) {
                        $_SESSION["comprobacionContraseña"] =
