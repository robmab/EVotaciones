...
if ($contadi == 1) {
    ...
    //_______________________________________________________
    //___Nombre convocatoria
    //_______________________________________________________

    $sql3 =
        "SELECT denominacion,circunscripcion,fecha FROM convocatoria where escrutinio='Abierto' ";
    ...
    for ($cont2 = 0; $cont < $num; $cont2++) {
        ...
        if ($memi1 && $memi1->num_rows > 0) {
            ...
            $sql1 =
                "SELECT * FROM resultado WHERE convocatoria=" .
                $info1["id"] .
                "";
    ...
    //_______________________________________________________
    //__Tras todas las opreaciones, aqui se resuelve
    //_______________________________________________________

    $sql50 =
        "SELECT denominacion,circunscripcion,fecha FROM convocatoria where id='" .
        $solucion .
        "' ";
...
if ($partido == "blanco") {
    $sq1c =
        "UPDATE votante SET votante='Si' WHERE nif='" .
        $_SESSION["user"] .
        "' ";
...
//_______________________________________________________
    ...
    $sq1 =
        "UPDATE partido SET votosTotales='" .
        $votos .
        "' WHERE siglas='" .
        $partido .
        "' ";
    ...
    if ($conexion->affected_rows > 0) {
        // echo "Se ha añadido a ". $nombre." ".$apellidos." a la base de datos.";
        ...
        if ($conexion->affected_rows > 0) {
            ...
            $_SESSION["mensajeBD"] =
                "Se ha votado a " . $partido . " (total Votos: " . $votos . ")";
        ...
        //  echo "Este votante ya se ha dado de alta.";
...
?><br><br><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
