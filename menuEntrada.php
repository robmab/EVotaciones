...
<html>
  <head>
    <title>Proyecto e-Votantes </title> <?php   
      session_start();
  ...
  <body> <?php include 'Extras/menu.php' ;
      ...
      <div class="table100 ver1 m-b-110">
        ...
        <center> <?php
             if (isset($_SESSION['sesionIniciada'])){
                    ...
                    echo  " 
						<p style='color:red;'> ". $_SESSION['sesionIniciada']."</p> "  ;
                    unset($_SESSION['sesionIniciada']);
                    }   ;
            ?> <h1> Usuario Logeado </h1> <?php   if ($_SESSION['rol'] == 'Administrador'){
               echo  '
						<h1> Administrador</h1>';
            } ;           
            ?> </center>
   ...
   echo $_SESSION['nombre'] ?> </td>
    ...
    echo $_SESSION['apellidos'] ?> </td>
                <td class="column100 column3" data-column="column3"> <?php
    
              echo $_SESSION['user'] ?> </td>
                <td class="column100 column3" data-column="column3"> <?php
    
              echo $_SESSION['fechaNac'] ?> </td>
                <td class="column100 column3" data-column="column3"> <?php
    
              echo $_SESSION['domicilio'] ?> </td>
                <td class="column100 column3" data-column="column3"> <?php
    
              echo $_SESSION['votante'] ?> </td>
              </tr>
              <tr align="right">
