...
<html lang="en">
  <head>
    <title>Alta Votantes</title> <?php   
        session_start();
        include 'Extras/css.php';
    ?>
  </head>
  <body> <?php    include 'Extras/menu.php';
    ...
    ?> <div class="container-contact100">
      <div class="wrap-contact100">
        <form class="contact100-form validate-form" action="controladorAltaVotantes.php" method="POST" onsubmit="return dobValidate('dn','date')">
          <span class="contact100-form-title"> Alta Votantes </span>
...
<span class="focus-input100"></span>undefined</div>undefined<?php
//             if (isset($_SESSION['dosPassw'])){
//                    
//                    echo  " undefined<p style='color:red;'> ". $_SESSION['dosPassw']."</p> "  ;
...
<div class="container-contact100-form-btn">
  <button type="submit" class="contact100-form-btn">
    <span>
      <i class="fa fa-paper-plane-o m-r-6" aria-hidden="true"></i> Confirmar </span>
  </button>
</div>undefined</form>undefined</div>undefined</div>undefined<div>undefined<br>undefined<center>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
    <a href="menuEntrada.php" class="btn btn-success">Atras</a>undefined
  </center>undefined</div>undefined<div id="dropDownSelect1"></div>undefined<?php    include 'Extras/scripts.php';
    ?>
</body>
</html>
