<?php
    ...
    if ($memi5 && $memi5->num_rows > 0) {
        $_SESSION["mensajeBD"] =
            "No puedes darte de alta mientras este el escrutinio abierto";
        header("Location:MensajeErrores.php");
        exit();
    }

    $sql5 =
        "SELECT * FROM votante WHERE votante='Si' AND nif='" .
        $_SESSION["user"] .
        "'";
    ...
    if ($memi5 && $memi5->num_rows > 0) {
        $_SESSION["mensajeBD"] =
            "No puedes modificar tu usuario si ya has votado ";
        header("Location:MensajeErrores.php");
        exit();
    }
    ...
    if (isset($_REQUEST["contraseña"])) {
        ...
        //  $contraseñaDec= base64_decode ($contraseñaEnc);
    ...
    $sq1 =
        "INSERT INTO votante(nif,domicilio,apellidos,fechaNac,password,rol,votante,nombre)   VALUES('" .
        $dni .
        "','" .
        $domicilio .
        "','" .
