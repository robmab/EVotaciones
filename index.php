...
<html lang="en">
  <head>
    <title>Autentificacion</title> <?php
        session_start();
  ...
  <body> <?php include "Extras/menu.php"; ?> <div class="container-contact100">
      <div class="wrap-contact100">
        <form class="contact100-form validate-form" action="Autentificacion.php" method="POST">
          ...
          </div> <?php if (isset($_SESSION["errDni"])) {
               echo " 
						<p style='color:red;'> " . $_SESSION["errDni"] . "</p> ";
    ...
    <div id="dropDownSelect1"></div> <?php include "Extras/scripts.php"; ?>
  </body>
</html>