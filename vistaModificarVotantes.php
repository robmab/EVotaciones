    ...
    <body>
        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form class="contact100-form validate-form" action="controladorModificarVotantes.php?probar=1" method="POST" onsubmit="return dobValidate('date')">
                    <span class="contact100-form-title">
                        Modificar votante 
                        <p><?php   echo  $_SESSION['datosVotante']['nombre'] ." ". $_SESSION['datosVotante']['apellidos'];   ?></p>
                    </span>
                    <div class="wrap-input100 validate-input" data-validate="Pon tu DNI">
                        <input class="input100" type="text" name="dni2" readonly="readonly" value="DNI: <?php   echo  $_SESSION['datosVotante']['nif'];      ?>">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate = "Pon tu Nombre">
                        <input style="text-transform: capitalize;" class="input100" type="text" name="nombre2" placeholder="Nombre: <?php   echo  $_SESSION['datosVotante']['nombre'];      ?>">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate = "Pon tus Apellidos">
                        <input  style="text-transform: capitalize;" class="input100" type="text" name="apellidos2" placeholder="Apellidos: <?php   echo  $_SESSION['datosVotante']['apellidos'];      ?>">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" >
                        <input class="input100" type="text" name="fechaN22" readonly="readonly"  value="Fecha Nacimiento: <?php   echo  $_SESSION['datosVotante']['fechaNac']      ?> ">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div style="text-transform: capitalize;" class="wrap-input100 validate-input" data-validate = "Pon tu Domicilio">
                        <input class="input100" type="text" name="domicilio2" placeholder="Domicilio: <?php   echo  $_SESSION['datosVotante']['domicilio'];      ?>">
                        <span class="focus-input100"></span>
                    </div>
                    <center>
                        <p>____________</p>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Repite la Contraseña">
                        <input id="passwd2" class="input100" type="password" name="contraseñaN2" placeholder="Repite Contraseña nueva" oninput="check(this)">
        ...
        <div class="container-contact100">
            <div class="table100 ver1 m-b-110">
                <br>
                <center>
                    <h1> Datos Votante <?php   echo  $_SESSION['datosVotante']['nombre'] ." ". $_SESSION['datosVotante']['apellidos'];   ?><b><?php 
                        ?>
                    </h1>
                </center>
                <br><br>
                        ...
                        <tbody>
                            ...
                            <tr class="row100">
                                <td class="column100 column1" data-column="column1"><?php
                                    echo $_SESSION['visionVot']['nif'] ?> </td>
                                <td class="column100 column2" data-column="column2"> <?php
                                    echo $_SESSION['visionVot']['nombre'] ?> </td>
                                <td class="column100 column3" data-column="column3"> <?php
                                    echo $_SESSION['visionVot']['apellidos'] ?> </td>
                                <td class="column100 column4" data-column="column4"> <?php
                                    echo $_SESSION['visionVot']['fechaNac'] ?> </td>
                                <td class="column100 column5" data-column="column5"> <?php
                                    echo $_SESSION['visionVot']['domicilio'] ?> </td>
                                <td class="column100 column6" data-column="column6"> <?php
                                    echo $_SESSION['visionVot']['rol'] ?> </td>
                                <td class="column100 column6" data-column="column6"> <?php
                                    echo $_SESSION['visionVot']['votante'] ?> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <?php
                    if (isset($_SESSION['comprobacionContraseña'])){
        ...
        <?php
            ...
            //_______________________________________________________   
            //Formulario edicion Usuario Administrador --> control de DNI
            //_______________________________________________________   
            //         else {
            //          ?>
        <!--        <div class="container-contact100">
            <div class="wrap-contact100">
                              <form class="contact100-form validate-form" action="controladorModificarVotantes.php" method="POST">
            		<span class="contact100-form-title">
            			DNI de votante a modificar
            		</span>
        ...
        //<?php
            //                    
            //                    if (isset($_SESSION['errDni10'])){
            //                    
            //                    echo  " <p style='color:red;'> ". $_SESSION['errDni10']."</p> "  ;
            //       
            //                    unset ($_SESSION['errDni10']) ;
            //                    }   ;
            //                    ?>
        <!--				<div class="container-contact100-form-btn">
